...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "SELECT * FROM staffevaluation WHERE FullName LIKE '%$search%' ";
...
<h2>
    ...
    <?php if (isset($participants)) { ?>
        ...
        <?php foreach ($participants as $participant) { ?>
            <p><?php echo $participant["FullName"] . " " . $participant["ProjectName"] . " " . $participant["number_of_hours_required_to_work_on_the_project"]  . " " . $participant["number_of_hours_of_project_delivery_delay"]; ?></p>
