...
function displayParticipants() {
    ...
    if (mysqli_num_rows($result) > 0) {
        echo "<h2><table>
                <tr>
                    <th>Full Name</th>
                    <th>reason for the punishment</th>
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            echo " <tr>
                    <td>".$row['FullName']."</td>
                    <td>".$row['reason_for_the_punishment']."</td>
                    <td>".$row['PunishmentDate']."</td>
                    <td>".$row['PunishmentName']."</td>
...
<h2>
   ...
   <a style="text-decoration:none" href="add_penalties.php">Add Employees</a> &nbsp &nbsp
   <a style="text-decoration:none" href="delete_penalties.php">Delete Employees</a> &nbsp &nbsp
   <a style="text-decoration:none" href="update_penalties.php">Update Employees</a> &nbsp &nbsp
   <a style="text-decoration:none" href="search_penalties.php">Search Employees</a> &nbsp &nbsp
    <hr style="width:100%;text-align:left;margin-left:0">

  </h2>

   <h3>
    <h2 style="color:black;">Penalties</h2>
