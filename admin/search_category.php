...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "SELECT * FROM category WHERE FullName LIKE '%$search%' ";
...
<h2>
    ...
    <?php if (isset($participants)) { ?>
        ...
        <?php foreach ($participants as $participant) { ?>
            <p><?php echo $participant["FullName"] . " " . $participant["JobTitle"] . " " . $participant["EmployeeGrade"]  . " " . $participant["Occupation"] . " " . $participant["Number_of_months_of_service_in_the_company"] . " " . $participant["Number_of_months_of_experience"]; ?></p>
