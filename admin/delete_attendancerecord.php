...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "DELETE FROM attendancerecord WHERE FirstName = '$FirstName'";

    if (mysqli_query($conn, $query)) {
        $success = "attendancerecord deleted successfully.";
    } else {
        $error = "Error deleting attendancerecord: " . mysqli_error($conn);
    }
}
?>
...
<html>
<head>
    <title>Delete attendancerecord</title>
	<meta charset="UTF-8">
...
<br></br>
    ...
    <form method="POST" action="">
		...
		<br></br>
        <input type="submit" value="Delete attendancerecord">
		<br></br>
				                               <hr style="width:100%;text-align:left;margin-left:0">
