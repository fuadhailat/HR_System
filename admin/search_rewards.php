...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "SELECT * FROM rewards WHERE FullName LIKE '%$search%' ";
...
<h2>
    ...
    <?php if (isset($participants)) { ?>
        ...
        <?php foreach ($participants as $participant) { ?>
            <p><?php echo $participant["FullName"] . " " . $participant["reason_for_the_reward"] . " " . $participant["BonusDate"]  . " " . $participant["BonusValue"]; ?></p>
