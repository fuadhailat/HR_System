...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "DELETE FROM salaries WHERE FullName = '$FullName'";

    if (mysqli_query($conn, $query)) {
        $success = "salaries deleted successfully.";
    } else {
        $error = "Error deleting salaries: " . mysqli_error($conn);
    }
}
?>
...
<br></br>
    ...
    <form method="POST" action="">
		...
		<br></br>
        <input type="submit" value="Delete salaries">
		<br></br>
				                               <hr style="width:100%;text-align:left;margin-left:0">
