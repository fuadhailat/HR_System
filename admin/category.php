    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            echo " <tr>
                    <td>".$row['FullName']."</td>
                    <td>".$row['JobTitle']."</td>
                    <td>".$row['EmployeeGrade']."</td>
                    <td>".$row['Occupation']."</td>
                    <td>".$row['Number_of_months_of_service_in_the_company']."</td>
                    <td>".$row['Number_of_months_of_experience']."</td>
...
<h2>
   ...
   <a style="text-decoration:none" href="add_category.php">Add Employees</a> &nbsp &nbsp
   <a style="text-decoration:none" href="delete_category.php">Delete Employees</a> &nbsp &nbsp
   <a style="text-decoration:none" href="update_category.php">Update Employees</a> &nbsp &nbsp
   <a style="text-decoration:none" href="search_category.php">Search Employees</a> &nbsp &nbsp
    <hr style="width:100%;text-align:left;margin-left:0">
