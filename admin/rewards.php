...
function displayParticipants() {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            echo " <tr>
                    <td>".$row['FullName']."</td>
                    <td>".$row['reason_for_the_reward']."</td>
                    <td>".$row['BonusDate']."</td>
...
<br></br>
   ...
   <a style="text-decoration:none" href="add_rewards.php">Add Employees</a> &nbsp &nbsp
   <a style="text-decoration:none" href="delete_rewards.php">Delete Employees</a> &nbsp &nbsp
   <a style="text-decoration:none" href="update_rewards.php">Update Employees</a> &nbsp &nbsp
   <a style="text-decoration:none" href="search_rewards.php">Search Employees</a> &nbsp &nbsp
    <hr style="width:100%;text-align:left;margin-left:0">
   ...
   <h3>
    <h2 style="color:black;">Rewards</h2>
