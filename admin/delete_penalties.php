...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "DELETE FROM penalties WHERE FullName = '$FullName'";

    if (mysqli_query($conn, $query)) {
        $success = "penalties deleted successfully.";
    } else {
        $error = "Error deleting penalties: " . mysqli_error($conn);
    }
}
?>
...
<br></br>
    ...
    <form method="POST" action="">
		...
		<br></br>
        <input type="submit" value="Delete penalties">
		<br></br>
				                               <hr style="width:100%;text-align:left;margin-left:0">
