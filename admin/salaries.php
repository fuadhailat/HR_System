...
<h2>
   ...
   <a style="text-decoration:none" href="add_salaries.php">Add Employees</a> &nbsp &nbsp
   <a style="text-decoration:none" href="delete_salaries.php">Delete Employees</a> &nbsp &nbsp
   <a style="text-decoration:none" href="update_salaries.php">Update Employees</a> &nbsp &nbsp
   <a style="text-decoration:none" href="search_salaries.php">Search Employees</a> &nbsp &nbsp
    <hr style="width:100%;text-align:left;margin-left:0">

  </h2>

   <h3>
    <h2 style="color:black;">Salaries</h2>
